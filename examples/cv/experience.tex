...
\begin{cvitems} % Description(s) of tasks/responsibilities		
		...
		\end{itemize}
		\item {\textbf{Loan Automation System} (Siddartha Bank Limited)\textsubscript{MVC}}
		\begin{itemize}
			\item {Reporting}
...
%---------------------------------------------------------
  \cventry
    ...
    {
    	\begin{cvitems} % Description(s) of tasks/responsibilities
    		\item {\textbf{Brikutimandap}\textsubscript{Windows Forms} (Bhrkutimandap, Widows Application)}
    		\begin{itemize}
